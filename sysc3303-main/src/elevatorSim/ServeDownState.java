...
public class ServeDownState extends ElevatorState {

	public ServeDownState(ElevatorSubsystem context) {
		super(context);
	}

	@Override
	public States getState() {
		return States.SERVING_DOWN;
	}
	...
	public void onEntry() {
		...
		int nextFloor = context.getNextDestination(false);
